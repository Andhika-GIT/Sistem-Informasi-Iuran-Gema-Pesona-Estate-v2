            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card ">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="/iurankeluar/simpan" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <!-- <div class="col-sm-6  ">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control <= ($validation->hasError('kode_iuran')) ? 'is-invalid' : ''; ?>" placeholder="Masukkan kode iuran keluar" name="kode_iuran" value="<?= old('kode_iuran'); ?>" required>
