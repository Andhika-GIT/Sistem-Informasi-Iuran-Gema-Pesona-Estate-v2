                ...
                <div class="col-lg-10">
                    ...
                    <div class="card card-primary">
                        <div class="card-header bg-green">
                            <p class="text-center ">Ubah Reply Thread : <?= $thread['judul']; ?></p>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="/reply/<?= $reply['id']; ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="isi" rows="10"><?= $reply['isi']; ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
