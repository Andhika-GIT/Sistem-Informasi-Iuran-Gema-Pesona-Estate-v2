                        ...
                        <div class="card-header">
                            <div class="row">
                                <div class="col-sm-10 card-title">
                                    <h3 class=" ">Daftar Transaksi Iuran Tunggakan</h3>
                                    <?php if (session()->get('role') == 'bendahara') { ?>
                                        <a type="button" class=" btn btn-success mr-1" href="<?= base_url('/iurantunggakan/export'); ?>" target="_blank">
                                            <i class="fas fa-file-export"></i> Ekspor/Cetak Data</i></a>
                                        <a type="button" class=" btn btn-primary" href="<?= base_url('/iurantunggakan/add'); ?>">
                                            ...
                                            <?php if (session()->get('role') == 'bendahara') { ?>
                                                <td align="center">
                                                    <div class="btn-group">
                                                        ...
                                                        <a href="/iurantunggakan/<?= $iuran['id']; ?>" class="btn btn-warning">Edit</a>

                                                        <form action="/iurantunggakan/<?= $iuran['id']; ?>" method="POST" class="d-inline">
                                                            <?= csrf_field(); ?>
