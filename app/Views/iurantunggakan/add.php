                ...
                <div class="col-lg-12">
                    ...
                    <div class="card ">
                        <div class="card-header">
                            <h3 class="card-title">Tambah Data Iuran Tunggakan</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="/iurantunggakan/simpan" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <!-- <div class="col-sm-12  ">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control <= ($validation->hasError('kode_tagihan')) ? 'is-invalid' : ''; ?>" placeholder=" Masukkan kode hutang" name="kode_tagihan" value="<?= old('kode_tagihan'); ?>" required>
